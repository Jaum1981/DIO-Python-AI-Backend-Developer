...
# número de telefone fornecido pelo cliente está em um formato correto. 
# Para garantir a precisão dos registros, é essencial que os números de telefone estejam 
# no formato padrão. Desenvolva uma função programa que valide se um número de telefone tem o 
# formato correto.
